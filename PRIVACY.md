...
This privacy policy applies to the Claude Monitor app (hereby referred to as "Application") for mobile devices that was created by Timothy Morgan (hereby referred to as "Service Provider") as an Open Source service. This service is intended for use "AS IS".
